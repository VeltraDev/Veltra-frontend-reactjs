...
export default function HeroSection() {
  ...
  return (
    ...
    <section className="">
      ...
      <div className='absolute inset-0 blur-xl h-[580px]' style={{ background: "linear-gradient(143.6deg, rgba(255, 255, 255, 0) 20.79%, rgba(255, 255, 255, 0.26) 40.92%, rgba(255, 255, 255, 0) 70.35%)" }}></div>
