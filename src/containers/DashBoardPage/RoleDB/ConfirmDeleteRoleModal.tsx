...
const ConfirmDeleteRoleModal: React.FC<ConfirmDeleteRoleModalProps> = ({ isOpen, onRequestClose, onDelete }) => {
  return (
    <Modal
      isOpen={isOpen}
      onRequestClose={onRequestClose}
      contentLabel="Confirm Delete Role"
    ...
    >
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md mx-auto relative">
        ...
        <h2 className="text-xl font-bold mb-4">Confirm Delete Role</h2>
