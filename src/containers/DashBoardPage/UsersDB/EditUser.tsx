      ...
      <div className="max-w-[1165px]">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              <button className="text-white">Save User</button>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between h-[300px]">
          <div className="p-6 w-[264px] shadow-lg bg-[#ffffff] rounded-[12px] flex flex-col gap-5">
            <span className="mb-2 text-[18px] font-semibold">Avatar</span>
            <div className="flex flex-col gap-4 justify-center items-center">
              ...
              {/* Nút chọn ảnh */}
              <label className="text-[#3858D6] bg-[#F4ECFB] py-[10px] px-[14px] rounded-[8px] cursor-pointer">
                Change Image
                <input
                  type="file"
                  accept="image/*"
          ...
          <div className="w-[860px]">
            <div className="bg-[#ffffff] p-6 shadow-lg rounded-[12px]">
              <h2 className="mb-2 text-[18px] font-semibold">Information</h2>
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border rounded-[8px] focus:outline-none"
                />
              </div>
              <div className="mb-6">
                <label className="block mb-2 text-sm font-medium">
              ...
              <div className="mb-6">
                ...
                <input
                  value={userDisplayStatus}
                  onChange={(e) => setUserDisplayStatus(e.target.value)}
                  className="w-full px-4 py-2 border rounded-[8px] focus:outline-none"
                />
              </div>
              <div className="mb-6">
                ...
                <input
                  type="checkbox"
                  checked={userIsVerified}
                  onChange={(e) => setUserIsVerified(e.target.checked)}
