...
const Toast: React.FC<ToastProps> = ({ status, message, handleCloseToast }) => {
  return (
    <>
      <div
        className={`fixed top-[13%] transition-all ease-in duration-300 right-[3%] z-50 ${
      ...
      >
        {status === 'success' && (
          <div
            id="toast-success"
            className="flex items-center w-full max-w-xs p-4 mb-4 text-black rounded-lg shadow border-l-[13px] border-solid border-green-500"
            role="alert"
          >
        ...
        {status === 'danger' && (
          <div
            id="toast-danger"
            className="flex items-center w-full max-w-xs p-4 mb-4 text-white rounded-lg shadow border-l-[13px] border-solid border-red-500"
            role="alert"
          >
        ...
        {status === 'warning' && (
          <div
            id="toast-warning"
            className="flex items-center w-full max-w-xs p-4 text-white rounded-lg shadow border-l-[13px] border-solid border-yellow-500"
            role="alert"
          >
